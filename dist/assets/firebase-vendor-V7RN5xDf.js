import{r as mt,b as xt,a as Bt,g as fi,i as Tr}from"./firebase-app-J8-aw7xu.js";import{o as Er}from"./vendor-Bg_btqvK.js";import{g as Ar}from"./firebase-auth-CkiyymQV.js";import{g as Sr}from"./firebase-firestore-BwGYsYUu.js";var Jn={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kr=()=>Rr().__FIREBASE_DEFAULTS__,Dr=()=>{if(typeof process>"u"||typeof Jn>"u")return;const i=Jn.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},Mr=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const r=i&&Or(i[1]);return r&&JSON.parse(r)},le=()=>{try{return kr()||Dr()||Mr()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},Pr=i=>{var r,o;return(o=(r=le())===null||r===void 0?void 0:r.emulatorHosts)===null||o===void 0?void 0:o[i]},jr=i=>{const r=Pr(i);if(!r)return;const o=r.lastIndexOf(":");if(o<=0||o+1===r.length)throw new Error(`Invalid host ${r} with no separate hostname and port!`);const u=parseInt(r.substring(o+1),10);return r[0]==="["?[r.substring(1,o-1),u]:[r.substring(0,o),u]},Ko=()=>{var i;return(i=le())===null||i===void 0?void 0:i.config},Xo=i=>{var r;return(r=le())===null||r===void 0?void 0:r[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=1e3,Wr=2,Kr=4*60*60*1e3,Xr=.5;function ti(i,r=qr,o=Wr){const u=r*Math.pow(o,i),c=Math.round(Xr*u*(Math.random()-.5)*2);return Math.min(Kr,u+c)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ke(i,r=!1){let o;const u=await fe(i.appConfig,v=>{if(!Pi(v))throw ut.create("not-registered");const I=v.authToken;if(!r&&Ds(I))return v;if(I.requestStatus===1)return o=Rs(i,r),v;{if(!navigator.onLine)throw ut.create("app-offline");const w=Ps(v);return o=ks(i,w),w}});return o?await o:u.authToken}async function Rs(i,r){let o=await ni(i.appConfig);for(;o.authToken.requestStatus===1;)await _i(100),o=await ni(i.appConfig);const u=o.authToken;return u.requestStatus===0?Ke(i,r):u}function ni(i){return fe(i,r=>{if(!Pi(r))throw ut.create("not-registered");const o=r.authToken;return js(o)?Object.assign(Object.assign({},r),{authToken:{requestStatus:0}}):r})}async function ks(i,r){try{const o=await _s(i,r),u=Object.assign(Object.assign({},r),{authToken:o});return await ae(i.appConfig,u),o}catch(o){if(Ti(o)&&(o.customData.serverCode===401||o.customData.serverCode===404))await Di(i.appConfig);else{const u=Object.assign(Object.assign({},r),{authToken:{requestStatus:0}});await ae(i.appConfig,u)}throw o}}function Pi(i){return i!==void 0&&i.registrationStatus===2}function Ds(i){return i.requestStatus===2&&!Ms(i)}function Ms(i){const r=Date.now();return r<i.creationTime||i.creationTime+i.expiresIn<r+ss}function Ps(i){const r={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},i),{authToken:r})}function js(i){return i.requestStatus===1&&i.requestTime+vi<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ns(i){const r=i,{installationEntry:o,registrationPromise:u}=await We(r);return u?u.catch(console.error):Ke(r).catch(console.error),o.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xs(i,r=!1){const o=i;return await Ls(o),(await Ke(o,r)).token}async function Ls(i){const{registrationPromise:r}=await We(i);r&&await r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji="installations",Fs="installations-internal",Hs=i=>{const r=i.getProvider("app").getImmediate(),o=Bs(r),u=Bt(r,"heartbeat");return{app:r,appConfig:o,heartbeatServiceProvider:u,_delete:()=>Promise.resolve()}},Us=i=>{const r=i.getProvider("app").getImmediate(),o=Bt(r,ji).getImmediate();return{getId:()=>Ns(o),getToken:c=>xs(o,c)}};function $s(){xt(new Lt(ji,Hs,"PUBLIC")),xt(new Lt(Fs,Us,"PRIVATE"))}$s();mt(mi,Ge);mt(mi,Ge,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he="analytics",zs="firebase_id",Vs="origin",Gs=60*1e3,qs="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Xe="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ks(i){if(!i.startsWith(Xe)){const r=G.create("invalid-gtag-resource",{gtagURL:i});return z.warn(r.message),""}return i}function Ni(i){return Promise.all(i.map(r=>r.catch(o=>o)))}function Xs(i,r){let o;return window.trustedTypes&&(o=window.trustedTypes.createPolicy(i,r)),o}function Ys(i,r){const o=Xs("firebase-js-sdk-policy",{createScriptURL:Ks}),u=document.createElement("script"),c=`${Xe}?l=${i}&id=${r}`;u.src=o?o==null?void 0:o.createScriptURL(c):c,u.async=!0,document.head.appendChild(u)}function Js(i){let r=[];return Array.isArray(window[i])?r=window[i]:window[i]=r,r}async function Zs(i,r,o,u,c,v){const I=u[c];try{if(I)await r[I];else{const E=(await Ni(o)).find(A=>A.measurementId===c);E&&await r[E.appId]}}catch(w){z.error(w)}i("config",c,v)}async function Qs(i,r,o,u,c){try{let v=[];if(c&&c.send_to){let I=c.send_to;Array.isArray(I)||(I=[I]);const w=await Ni(o);for(const E of I){const A=w.find(k=>k.measurementId===E),j=A&&r[A.appId];if(j)v.push(j);else{v=[];break}}}v.length===0&&(v=Object.values(r)),await Promise.all(v),i("event",u,c||{})}catch(v){z.error(v)}}function to(i,r,o,u){async function c(v,...I){try{if(v==="event"){const[w,E]=I;await Qs(i,r,o,w,E)}else if(v==="config"){const[w,E]=I;await Zs(i,r,o,u,w,E)}else if(v==="consent"){const[w,E]=I;i("consent",w,E)}else if(v==="get"){const[w,E,A]=I;i("get",w,E,A)}else if(v==="set"){const[w]=I;i("set",w)}else i(v,...I)}catch(w){z.error(w)}}return c}function eo(i,r,o,u,c){let v=function(...I){window[u].push(arguments)};return window[c]&&typeof window[c]=="function"&&(v=window[c]),window[c]=to(v,i,r,o),{gtagCore:v,wrappedGtag:window[c]}}function no(i){const r=window.document.getElementsByTagName("script");for(const o of Object.values(r))if(o.src&&o.src.includes(Xe)&&o.src.includes(i))return o;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uo(i=fi(),r=ze){const u=Bt(ue(i),Fi).getImmediate({identifier:r}),c=jr("functions");return c&&$o(u,...c),u}function $o(i,r,o){xo(ue(i),r,o)}Ho(fetch.bind(self));const zo={apiKey:"AIzaSyDZhiOJtUwK0HSmQirbdmqoSE2eTU6-sVY",authDomain:"it-inventory-management-5bf72.firebaseapp.com",projectId:"it-inventory-management-5bf72",storageBucket:"it-inventory-management-5bf72.firebasestorage.app",messagingSenderId:"985934309228",appId:"1:985934309228:web:2e848d7cc4b33141cd7549",measurementId:"G-W4MS0G7Y6V"},pe=Tr(zo);Io(pe);const ha=Ar(pe),la=Sr(pe);Uo(pe);export{Ro as A,Po as B,aa as C,Mo as D,Ve as E,Ft as F,Do as G,la as H,So as I,ha as J,is as L,bo as M,ko as S,_o as W,Co as X,Lt as a,Zn as b,ue as c,yi as d,Xo as e,Pr as f,Ko as g,sa as h,Br as i,di as j,ta as k,na as l,ia as m,Jo as n,Qo as o,Or as p,ra as q,R as r,Lr as s,Zo as t,oa as u,Fr as v,jr as w,Yo as x,ea as y,Oo as z};
